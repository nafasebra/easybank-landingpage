  ...
  return (
    <>
      ...
      <div className="bg-extra-light">
        <SectionContainer>
          <div className="py-10">
            <h2 className="capitalize py-5 text-xl lg:text-3xl text-center lg:text-left">
              why choose Easybank
            </h2>
            ...
            <div className="py-5 flex flex-col lg:flex-row flex-wrap justify-between">
              <div className="w-[90%] lg:w-[23%] mx-auto lg:mx-0 py-5">
                ...
                />
                <h3 className="capitalize text-xl py-4 text-center lg:text-left">
                  Online banking
                </h3>
      ...
      <SectionContainer>
        <div className="py-10">
          <h2 className="text-xl lg:text-3xl py-7 capitalize">
            latest article
          </h2>
